...
<!-- [0.3]{} ![image]({{ site.url }}{{ site.baseurl }}/images/2019-02-10-supervised-learning-survey/DTC_linsep_boxes.png){width="\linewidth"}

[0.3]{} ![image]({{ site.url }}{{ site.baseurl }}/images/2019-02-10-supervised-learning-survey/DTC_lininsep_boxes.png){width="\linewidth"} -->
...
Curve]({{ site.url }}{{ site.baseurl }}/images/2019-02-10-supervised-learning-survey/adaboost_alphacurve.png "fig:"){width="\linewidth"}

[0.55]{} ![Current Alpha-Error
Curve]({{ site.url }}{{ site.baseurl }}/images/2019-02-10-supervised-learning-survey/ABC_error_alpha.png "fig:"){width="\linewidth"} -->
...
Params]({{ site.url }}{{ site.baseurl }}/images/2019-02-10-supervised-learning-survey/linearly_seperable/KNNC_Param_Tuning_Testing_Time.png "fig:"){width="\linewidth"}

[0.45]{} ![Testing Times for
Params]({{ site.url }}{{ site.baseurl }}/images/2019-02-10-supervised-learning-survey/linearly_inseperable/KNNC_Param_Tuning_Testing_Time.png "fig:"){width="\linewidth"} -->
